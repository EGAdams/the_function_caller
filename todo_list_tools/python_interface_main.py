...
from python_menu_interface.edit_todo_description_command.edit_todo_description_command import EditTodoDescriptionCommand
...
if __name__ == "__main__":
    ...
    menu.register( "1", AddTodoSubtaskCommand(tool_factory.create_tool("add_todo_subtask")))
    menu.register( "2", EditTodoDescriptionCommand(tool_factory.create_tool( "edit_todo_description" )))
    menu.register( "3", ShowTodoListCommand(storage_handler))
    menu.register( "4", ShowStorageHandlerPathCommand( storage_handler ))
