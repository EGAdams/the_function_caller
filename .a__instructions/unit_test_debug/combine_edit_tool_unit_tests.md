Please combine the following unit tests into one test file.  If the tests are duplicates, please remove them.
# Source files
```py
import unittest
...
I'm not sure whether or not to use mock or not.