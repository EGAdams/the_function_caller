...
# Smart Menu
smart_menu_path        = os.path.join( base_dir, "smart_menu"                                )

path = os.path.join( smart_menu_path, "CommandExecutor.py"             )
process_python_file( path, output_file_path, append_mode=False              )

path = os.path.join( smart_menu_path, "ConfigReader.py"                       )
process_python_file( path, output_file_path, append_mode=True               )

path = os.path.join( smart_menu_path, "DialogMenu.py"                 )
process_python_file( path, output_file_path, append_mode=True               )

path = os.path.join( smart_menu_path, "Menu.py"             )
process_python_file( path, output_file_path, append_mode=True               )

path = os.path.join( smart_menu_path, "MenuItem.py"                 )
process_python_file( path, output_file_path, append_mode=True               )

path = os.path.join( smart_menu_path, "MenuManager.py"                 )
process_python_file( path, output_file_path, append_mode=True               )

path = os.path.join( smart_menu_path, "SmartMenuItem.py"                 )
process_python_file( path, output_file_path, append_mode=True               )
