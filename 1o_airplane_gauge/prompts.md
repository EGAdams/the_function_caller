...
<html lang="en">
    <head>
        ...
        <script>
            (function() {
                var t, i, e, s, n, o, a, h, r, l, c, p, u, d, g = [].slice, m = {}.hasOwnProperty, f = function(t, i) {
                    for (var e in i)
                        m.call(i, e) && (t[e] = i[e]);
                    function s() {
                        this.constructor = t
                ...
                !function() {
                    var t, i, e, s, n, o, a;
                    for (e = 0,
                    n = (a = ["ms", "moz", "webkit", "o"]).length; e < n && (o = a[e],
                    ...
                    s = 0,
                    i = {},
                    window.requestAnimationFrame ? window.cancelAnimationFrame || (t = window.requestAnimationFrame,
                ...
                p = function() {
                    var t, i, e;
                    return e = (i = 1 <= arguments.length ? g.call(arguments, 0) : [])[0],
                    t = i[1],
                    l(e.toFixed(t))
                }
                ,
                ...
                s = function(t) {
                    ...
                    i.prototype.setMinValue = function(t, i) {
                        ...
                        null == i && (i = !0),
                        i) {
                            for (this.displayedValue = this.minValue,
                            a = [],
                            s = 0,
                            n = (o = this.gp || []).length; s < n; s++)
                                e = o[s],
                    ...
                    i.prototype.setOptions = function(t) {
                        ...
                        this.options.angle > .5 && (this.options.angle = .5),
                    ...
                    i.prototype.configDisplayScale = function() {
                        var t, i, e, s, n;
                        return s = this.displayScale,
                        !1 === this.options.highDpiSupport ? delete this.displayScale : (i = window.devicePixelRatio || 1,
                        ...
                        this.displayScale !== s && (n = this.canvas.G__width || this.canvas.width,
                    ...
                    i.prototype.parseValue = function(t) {
                        return t = parseFloat(t) || Number(t),
                        isFinite(t) ? t : 0
                    }
                    ,
                    i
                    ...
                    t.prototype.update = function(t) {
                        var i;
                        return null == t && (t = !1),
                        !(!t && this.displayedValue === this.value) && (this.ctx && this.clear && this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height),
                ...
                a = function(t) {
                    ...
                    i.prototype.render = function() {
                        ...
                        if (t = this.gauge.getAngle.call(this, this.displayedValue),
                        ...
                        this.ctx.fill(),
                        this.img)
                            return s = Math.round(this.img.width * this.options.iconScale),
                ...
                function() {
                    ...
                    t.prototype.render = function() {
                        var t, i;
                        return this.textField && this.textField.text(p(this.value)),
                ...
                o = function(t) {
                    ...
                    e.prototype.paddingTop = .1,
                    e.prototype.paddingBottom = .1,
                    ...
                    e.prototype.setOptions = function(t) {
                        ...
                        this.extraPadding = 0,
                        this.options.angle < 0 && (o = Math.PI * (1 + this.options.angle),
                        ...
                        s = 0,
                        n = (a = this.gp).length; s < n; s++)
                            (i = a[s]).setOptions(this.options.pointer),
                            i.render();
                        return this.render(),
                        this
                    }
                    ...
                    e.prototype.configPercentColors = function() {
                        var t, i, e, s, n, o, a;
                        if (this.percentColors = null,
                        void 0 !== this.options.percentColors) {
                            for (this.percentColors = new Array,
                            o = [],
                            e = s = 0,
                            n = this.options.percentColors.length - 1; 0 <= n ? s <= n : s >= n; e = 0 <= n ? ++s : --s)
                    ...
                    e.prototype.set = function(t) {
                        ...
                        for (t instanceof Array || (t = [t]),
                        s = n = 0,
                        l = t.length - 1; 0 <= l ? n <= l : n >= l; s = 0 <= l ? ++n : --n)
                            t[s] = this.parseValue(t[s]);
                        if (t.length > this.gp.length)
                            for (s = o = 0,
                            c = t.length - this.gp.length; 0 <= c ? o < c : o > c; s = 0 <= c ? ++o : --o)
                    ...
                    e.prototype.getColorForPercentage = function(t, i) {
                        ...
                        if (0 === t)
                            ...
                            for (e = this.percentColors[this.percentColors.length - 1].color,
                            n = o = 0,
                            h = this.percentColors.length - 1; 0 <= h ? o <= h : o >= h; n = 0 <= h ? ++o : --o)
                                if (t <= this.percentColors[n].pct) {
                                    !0 === i ? (r = this.percentColors[n - 1] || this.percentColors[0],
                    ...
                    e.prototype.getColorForValue = function(t, i) {
                        var e;
                        return e = (t - this.minValue) / (this.maxValue - this.minValue),
                    ...
                    e.prototype.renderStaticLabels = function(t, i, e, s) {
                        ...
                        a = 0,
                        h = (c = t.labels).length; a < h; a++)
                            void 0 !== (g = c[a]).label ? (!this.options.limitMin || g >= this.minValue) && (!this.options.limitMax || g <= this.maxValue) && (r = (n = g.font || t.font).match(l)[0],
                            u = n.slice(r.length),
                            o = parseFloat(r) * this.displayScale,
                            this.ctx.font = o + u,
                    ...
                    e.prototype.renderTicks = function(t, i, e, s) {
                        ...
                        if (t !== {}) {
                            ...
                            g = l + 1; c < g; S = c += 1)
                                ...
                                o = n + v,
                                n += d,
                                S !== t.divisions && w > 0 ? m.push(function() {
                                    var t, i, e;
                                    for (e = [],
                                    t = 0,
                                    i = w - 1; t < i; t += 1)
                    ...
                    e.prototype.render = function() {
                        ...
                        this.options.staticZones)
                            ...
                            s = 0,
                            o = (c = this.options.staticZones).length; s < o; s++)
                                r = (x = c[s]).min,
                                ...
                                x.height && (this.ctx.lineWidth = this.lineWidth * x.height,
                            ...
                            void 0 !== this.options.customFillStyle ? i = this.options.customFillStyle(this) : null !== this.percentColors ? i = this.getColorForValue(this.displayedValue, this.options.generateGradient) : void 0 !== this.options.colorStop ? (0 === this.options.gradientType ? (d = l - this.lineWidth / 2,
                            g = l + this.lineWidth / 2,
                            i = this.ctx.createRadialGradient(f, e, d, f, e, g)) : i = this.ctx.createLinearGradient(0, 0, f, 0),
                ...
                e = function(t) {
                    ...
                    ,
                    e.prototype.set = function(t) {
                        return this.value = this.parseValue(t),
                        this.value > this.maxValue ? this.options.limitMax ? this.value = this.maxValue : this.maxValue = this.value : this.value < this.minValue && (this.options.limitMin ? this.value = this.minValue : this.minValue = this.value),
                        i.add(this),
                        i.run(this.forceUpdate),
                        this.forceUpdate = !1
                    }
                    ...
                    e.prototype.render = function() {
                        var t, i, e, s, n, o;
                        return t = this.getAngle(this.displayedValue),
                ...
                n = function(t) {
                    ...
                    i.prototype.strokeGradient = function(t, i, e, s) {
                        var n;
                        return (n = this.ctx.createRadialGradient(t, i, e, t, i, s)).addColorStop(0, this.options.shadowColor),
                        n.addColorStop(.12, this.options._orgStrokeColor),
                        n.addColorStop(.88, this.options._orgStrokeColor),
                ...
                i = {
                    ...
                    addAll: function(t) {
                        ...
                        n = t.length; s < n; s++)
                            e = t[s],
                            o.push(i.elements.push(e));
                        return o
                    },
                    add: function(t) {
                        if (x.call(i.elements, t) < 0)
                            return i.elements.push(t)
                    },
                    run: function(t) {
                        var e, s, n, o, a, h, r;
                        if (null == t && (t = !1),
                        isFinite(parseFloat(t)) || !0 === t) {
                            for (e = !0,
                            r = [],
                            n = s = 0,
                            a = (h = i.elements).length; s < a; n = ++s)
                        ...
                        if (!1 === t)
                            return !0 === i.animId && cancelAnimationFrame(i.animId),
    ...
    <body>
        ...
        <template id="g-force-needle-template">
            <style>
                :host {
                    display: block;
                    width: 100%;
        ...
        <script defer>
            class GForceScale extends HTMLElement {
                constructor() {
                    super();
                    this.attachShadow({
                        mode: 'open'
                    ...
                    const gauge = new Gauge(canvas).setOptions({
                        angle: 0.5,
                        // Start at 8:00 and end at 4:00 position
                        lineWidth: 0.1,
                        radiusScale: 1,
                        pointer: {
                            length: 0.6,
                            // Adjust the length of the pointer (needle)
                            strokeWidth: 0.035,
                    ...
                    gauge.set(0);
                    // Initial value at 0 G
                }

                updateGForce(value) {
                    const gauge = this.shadowRoot.querySelector('canvas').gauge;
                    gauge.set(value);
                }
            }

            class RedGForceNeedle extends HTMLElement {
                constructor() {
                    super();
                    this.attachShadow({
                        mode: 'open'
                    ...
                    const needle = new Gauge(canvas).setOptions({
                        angle: 0.5,
                        lineWidth: 0.05,
                        pointer: {
                            length: 0.9,
                            // Red needle for full range
                            strokeWidth: 0.04,
                            color: '#ff0000'
                        }
                    });

                    needle.setMinValue(-100);
                    needle.setMaxValue(100);
                    needle.set(0);
                    // Initial position at 0 G
                }

                updateNeedle(value) {
                    const needle = this.shadowRoot.querySelector('canvas').needle;
                    needle.set(value);
                }
            }

            customElements.define('g-force-scale', GForceScale);
            customElements.define('red-g-force-needle', RedGForceNeedle);
        </script>
        <script defer>
...
class TestGauge extends HTMLElement {
     connectedCallback() {
       ...
       // Trigger your script when the element is connected to the DOM
       const script = document.createElement('script');
       script.textContent = `
         const gForceNeedle = this.shadowRoot.querySelector('g-force-needle');
         // ... rest of your code ...
       `;
